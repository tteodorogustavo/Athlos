    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('ADMIN', 'Admin da Academia'), ('PERSONAL', 'Personal Trainer'), ('ALUNO', 'Aluno')], default='ALUNO', max_length=10, verbose_name='Tipo de Usuário')),
                ('academia', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='academias.academia', verbose_name='Academia')),
